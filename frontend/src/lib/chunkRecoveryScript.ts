...
(function() {
  ...
  function recoverFromChunkFailure() {
    ...
    writeRecoveryMarker();
    preferPreviousShell().then(function() { window.location.reload(); }, function() { window.location.reload(); });
  }
