...
export default function TaskCalendarView({ tasks, lists, folders, statuses, users, currentUserID, scopeListID, onOpen, onCreated, onOperation, onMore }: Props) {
  ...
  const create = async () => {
    if (!composer || !title.trim() || !selectedList || !status || !ownerID || saving) return
    setSaving(true)
