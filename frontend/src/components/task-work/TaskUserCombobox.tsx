  ...
  return <>
    ...
    {open && typeof document !== 'undefined' && createPortal(<>
      ...
      <div style={style} className="fixed z-[110] overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-2xl shadow-slate-900/15">
        ...
        }} placeholder="Escribe un nombre o usuario…" className="w-full rounded-xl bg-slate-50 py-2.5 pl-10 pr-3 text-sm outline-none focus:bg-white focus:ring-2 focus:ring-emerald-200" /></div>
