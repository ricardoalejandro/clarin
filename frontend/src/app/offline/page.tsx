...
const OFFLINE_STYLES = `
  ...
  * { box-sizing: border-box; }
  ...
  .clarin-offline-mark { display: block; width: 2.75rem; height: 2.75rem; flex: none; border-radius: 1rem; box-shadow: 0 10px 25px rgba(2,44,34,.4); }
  .clarin-offline-state svg { width: 1.25rem; height: 1.25rem; }
