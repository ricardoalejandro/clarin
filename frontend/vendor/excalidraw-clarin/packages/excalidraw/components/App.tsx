  ...
  constructor(props: AppProps) {
    ...
    if (excalidrawAPI) {
      const api: ExcalidrawImperativeAPI = {
        ...
        preloadFonts: () => this.fonts.preloadSelectableFonts(false),
        retryFontPreload: () => this.fonts.preloadSelectableFonts(true),
        subscribeFontPreloadProgress: this.fonts.subscribePreloadProgress,
        getFontPreloadProgress: this.fonts.getPreloadProgress,
      } as const;
      ...
      this.scene.replaceAllElements([
        ...
        ...this.scene.getElementsIncludingDeleted().map((_element) => {
          if (_element.id === element.id && isTextElement(_element)) {
            const textCustomData =
              typeof clarinTextFormat === "undefined"
                ? _element.customData
                : updateClarinTextCustomData(
                    _element.customData,
                    clarinTextFormat,
            ...
            const nextCustomData =
              typeof clarinParagraphFormat === "undefined"
                ? textCustomData
                : updateClarinParagraphCustomData(
                    textCustomData,
                    clarinParagraphFormat,
                  );
            const nextTextAlign = textAlign ?? _element.textAlign;
      ...
      onChange: (
        ...
        withBatchedUpdates(
          (payload: {
            ...
            updateElement(
              payload.nextOriginalText,
              false,
              payload.clarinTextFormat,
              payload.clarinParagraphFormat,
              payload.textAlign,
            );
