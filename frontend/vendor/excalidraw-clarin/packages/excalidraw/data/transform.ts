...
import { getClarinTextFormat } from "../element/clarinRichText";
  ...
  for (const element of elements) {
    ...
    switch (element.type) {
      ...
      case "text": {
        ...
        const metrics = getClarinTextFormat(measurementElement)
          ? measureClarinText(measurementElement, normalizedText)
          : measureText(
              normalizedText,
