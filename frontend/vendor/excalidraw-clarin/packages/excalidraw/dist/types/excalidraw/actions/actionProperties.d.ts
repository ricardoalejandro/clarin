...
export declare const actionToggleTextBold: {
    ...
    PanelComponent: ({ elements, appState, appProps, updateData, }: {
...
export declare const actionToggleTextItalic: {
...
export declare const actionToggleTextUnderline: {
...
export declare const actionToggleTextStrike: {
