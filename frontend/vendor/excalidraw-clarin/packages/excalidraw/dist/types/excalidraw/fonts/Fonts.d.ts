...
export declare class Fonts {
    ...
    private static clarinPreloadProgress;
    private static readonly clarinPreloadListeners;
    private static readonly clarinReadyFamilies;
    private static readonly clarinFailedFamilies;
    private static clarinPreloadPromise;
    private static clarinOnlineRetryBound;
    private static clarinLastInstance;
    ...
    static getPreloadProgress: () => ClarinFontPreloadProgress;
    static subscribePreloadProgress: (listener: (progress: ClarinFontPreloadProgress) => void) => () => void;
    subscribePreloadProgress: (listener: (progress: ClarinFontPreloadProgress) => void) => () => void;
    getPreloadProgress: () => ClarinFontPreloadProgress;
    /** Loads every selectable local family before the catalog is interactive. */
    preloadSelectableFonts: (retryFailed?: boolean) => Promise<ClarinFontPreloadProgress>;
    /**
