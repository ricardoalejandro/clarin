...
export interface ExcalidrawProps {
    /** Enables Clarin's source-audited partial bold/italic/underline/strike editor. */
...
export interface ExcalidrawImperativeAPI {
    preloadFonts: InstanceType<typeof App>["fonts"]["preloadSelectableFonts"];
    retryFontPreload: InstanceType<typeof App>["fonts"]["preloadSelectableFonts"];
    subscribeFontPreloadProgress: InstanceType<typeof App>["fonts"]["subscribePreloadProgress"];
    getFontPreloadProgress: InstanceType<typeof App>["fonts"]["getPreloadProgress"];
