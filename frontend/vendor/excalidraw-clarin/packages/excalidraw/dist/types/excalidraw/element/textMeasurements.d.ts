...
export declare const getClarinTextWidth: (element: ExcalidrawTextElement, text?: string) => number;
export declare const measureClarinText: (element: ExcalidrawTextElement, text?: string) => {
    width: number;
    height: number;
};
