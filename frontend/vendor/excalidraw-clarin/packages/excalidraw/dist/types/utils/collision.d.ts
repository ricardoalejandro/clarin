...
export declare const pointOnCurve: <Point extends LocalPoint | GlobalPoint>(point: Point, curve: Curve<Point>, threshold: number) => boolean;
export declare const pointOnPolyline: <Point extends LocalPoint | GlobalPoint>(point: Point, polyline: Polyline<Point>, threshold?: number) => boolean;
