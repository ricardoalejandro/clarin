...
import { wrapClarinText, wrapText } from "./textWrapping";
...
import { measureClarinText, measureText } from "./textMeasurements";
...
export const redrawTextBoundingBox = (
  ...
  if (container || !textElement.autoResize) {
    maxWidth = container
      ...
      : textElement.width;
    boundTextUpdates.text = wrapClarinText(textElement, maxWidth);
  }

  const metrics = measureClarinText(textElement, boundTextUpdates.text);
...
export const handleBindTextResize = (
  ...
  if (textElement && textElement.text) {
    ...
    if (
      ...
      if (text) {
        text = wrapClarinText(textElement, maxWidth);
      }
      const metrics = measureClarinText(textElement, text);
