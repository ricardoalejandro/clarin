...
func TestWhiteboardMigrationKeepsIsolationRevisionAndGuestInvariants(t *testing.T) {
	...
	for _, invariant := range []string{
		...
		"whiteboard_library_import_status_check",
		"whiteboard_library_import_completed_version_check",
		"completed_library_version IS NOT NULL",
		"unconfirmed_library_version",
		"UNIQUE(token_hash)",
		"uq_whiteboard_library_import_completion",
