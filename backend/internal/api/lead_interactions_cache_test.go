...
func TestLeadInteractionsCacheKeysStayAccountScoped(t *testing.T) {
	...
	if want := "lead_interactions:v2:11111111-1111-1111-1111-111111111111:22222222-2222-2222-2222-222222222222:100:0"; key != want {
		t.Fatalf("leadInteractionsCacheKey() = %q, want %q", key, want)
	}
	if want := "lead_interactions:v2:11111111-1111-1111-1111-111111111111:22222222-2222-2222-2222-222222222222:*"; pattern != want {
