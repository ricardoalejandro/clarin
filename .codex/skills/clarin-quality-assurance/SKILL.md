...
- Exercise Program participant dates with automatic defaults, explicit past/future corrections, account isolation, inclusive enrollment, exclusive withdrawal/completion, no eligible sessions, pending sessions, and real attendance before/after the participation window. Historical records must remain visible and must not alter P/F/T rates.
