...
- Use one vertical scroll owner and this accordion order: Contact information, Contact tags, direct observations, general Contact history, contextual opportunity/event data, related tasks, integrations. Direct and general observations remain separate but contiguous; open the first three by default and collapse the rest.
